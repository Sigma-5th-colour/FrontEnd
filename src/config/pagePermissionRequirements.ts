...
export const PAGE_PERMISSION_REQUIREMENTS: Record<string, readonly string[]> = {
  ...
  '/hr/attendance': HR_SELF_SERVICE_PERMISSIONS,
  '/hr/shifts': [APP_PERMISSIONS.HR_SHIFT_MANAGE, APP_PERMISSIONS.HR_FULL_ACCESS],
  '/hr/reports': [APP_PERMISSIONS.HR_REPORT_EXPORT, APP_PERMISSIONS.HR_FULL_ACCESS],
  ...
  '/hr/permission-requests': HR_SELF_SERVICE_PERMISSIONS,
  '/hr/resignation-request': HR_SELF_SERVICE_PERMISSIONS,
  '/hr/resignation-requests': HR_SELF_SERVICE_PERMISSIONS,
  '/hr/custody-request': HR_SELF_SERVICE_PERMISSIONS,
  '/hr/custody-requests': HR_SELF_SERVICE_PERMISSIONS,
